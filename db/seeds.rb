...
photo1 = Photo.create(img_url: "SEED DATA/ZTO5ntSqUKA.jpg", title: (Faker::Hipster.words(1)).first, description: Faker::Hipster.sentences(1).first, author_id: user2.id)
photo2 = Photo.create(img_url: "SEED DATA/zh7GEuORbUw.jpg", title: (Faker::Hipster.words(1)).first, description: Faker::Hipster.sentences(1).first, author_id: user2.id)
photo3 = Photo.create(img_url: "SEED DATA/yPBHXvN3HII.jpg", title: (Faker::Hipster.words(1)).first, description: Faker::Hipster.sentences(1).first, author_id: user2.id)
photo4 = Photo.create(img_url: "SEED DATA/xmtqxA_9Has.jpg", title: (Faker::Hipster.words(1)).first, description: Faker::Hipster.sentences(1).first, author_id: user2.id)
photo5 = Photo.create(img_url: "SEED DATA/x-agyuDQHJA.jpg", title: (Faker::Hipster.words(1)).first, description: Faker::Hipster.sentences(1).first, author_id: user2.id)
photo6 = Photo.create(img_url: "SEED DATA/URlcLAfyYGU.jpg", title: (Faker::Hipster.words(1)).first, description: Faker::Hipster.sentences(1).first, author_id: user2.id)
photo7 = Photo.create(img_url: "SEED DATA/vEkB7Lp4w0o.jpg", title: (Faker::Hipster.words(1)).first, description: Faker::Hipster.sentences(1).first, author_id: user2.id)
photo8 = Photo.create(img_url: "SEED DATA/s0rShYnmtEI.jpg", title: (Faker::Hipster.words(1)).first, description: Faker::Hipster.sentences(1).first, author_id: user2.id)
photo9 = Photo.create(img_url: "SEED DATA/R22d5ErIWY8.jpg", title: (Faker::Hipster.words(1)).first, description: Faker::Hipster.sentences(1).first, author_id: user2.id)
photo10 = Photo.create(img_url: "SEED DATA/QlL_MIF7Xjc.jpg", title: (Faker::Hipster.words(1)).first, description: Faker::Hipster.sentences(1).first, author_id: user2.id)
